 ...
 public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //1 - AdapterView: a list view
        ...
        dataModels.add(new CountryModelClass("England","1", R.drawable.england));
        dataModels.add(new CountryModelClass("United States","0", R.drawable.usa));
        dataModels.add(new CountryModelClass("Saudi Arabia","0", R.drawable.saudi));
        //3 - Adapter
        ...
        //4- Handling the click events on Listview i
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l ){
                Toast.makeText(MainActivity.this,
                        "Country" + adapter.getItem(i).getCountry_name()+"\n"+
                                "Worldcup wins: "+adapter.getItem(i).getCup_win_count(),
